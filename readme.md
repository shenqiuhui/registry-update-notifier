...
```
$ npm install registry-update-notifier
```
...
```js
const updateNotifier = require('registry-update-notifier');
...
You can set the source of the private library using this parameter.
